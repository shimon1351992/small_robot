...
const [showTextEditor, setShowTextEditor] = useState(false);
  ...
  const pages = {
    ...
    app: [
      ...
      { images: ['https://i.imgur.com/eAdhuAt.png'], time: 2 },
      { images: ['https://i.imgur.com/LfEwuWN.png'], time: 3 },
      { images: ['https://i.imgur.com/xdTCdlV.png'], time: 4 },
      { images: ['https://i.imgur.com/fLnwnGn.png'], time: 5 },
      { images: ['https://i.imgur.com/Xh4UNxE.png'], time: 6 },
      { images: ['https://i.imgur.com/f7wpauS.png'], time: 7 },
      { images: ['https://i.imgur.com/UiDVJj2.png'], time: 8 },
      { images: ['https://i.imgur.com/xdjPNxc.png'], time: 9 },
      { images: ['https://i.imgur.com/ZzGmkIw.png'], time: 10 },
      { images: ['https://i.imgur.com/iKot9O8.png'], time: 11 },
      { images: ['https://i.imgur.com/W4iMFFH.png'], time: 12 },
      { images: ['https://i.imgur.com/x4zIrKS.png'], time: 13 },
      { images: ['https://i.imgur.com/lvfOlqg.png'], time: 14 },
      { images: ['https://i.imgur.com/EmzJNTf.png'], time: 15 },
      { images: ['https://i.imgur.com/M7AwC9F.png'], time: 16 },
 ...
 const openBuilderInNewTab = () => {
  ...
  fetch('/toolbox.json')
    ...
    .then(data => {
      ...
      const url = `/builder?toolbox=${toolboxParam}`;
